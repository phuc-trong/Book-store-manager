...
public class OrderDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (path.startsWith("/EorderDetail/updateSuccess")) {
            ...
            request.getRequestDispatcher(folder + "/EorderDetail.jsp").forward(request, response);

        } else if (path.startsWith("/EorderDetail/updateFail")) {
            String[] data = path.split("/");
            String id = data[data.length - 1];
            OrderDetailDAO odd = new OrderDetailDAO();
            OrderDAO ord = new OrderDAO();
        ...
        } else if (path.startsWith("/EorderDetail")) {
            String[] data = path.split("/");
            String id = data[data.length - 1];
            OrderDetailDAO odd = new OrderDetailDAO();
            OrderDAO ord = new OrderDAO();
